...
\newcommand{\hlblue}[1]{{\sethlcolor{White!90!NavyBlue}\hl{#1}}}
\newcommand{\hlred}[1]{{\sethlcolor{White!90!Maroon}\hl{#1}}}
...
\begin{frame}
  ...
  \begin{itemize}
  \item[{\color{Red} \ding{43}}] Background
    \begin{itemize}
...
\begin{frame}[containsverbatim]
  ...
  \footnotetext{\hlblue{Blue:} types with statically-known security.
    \hlred{Red:} types with unknown security.}
\end{frame}
...
\onslide<2-> {
  \begin{center}
    \color{Red}
    There is a tension between the gradual guarantee and IFC! \\[2ex] {\Large \frownie{}}
  \end{center}
}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Background
  \item[{\color{Red} \ding{43}}] \Surface: a gradual IFC calculus
    \begin{itemize}
      \item \Surface enforces IFC while satisfying gradual guarantee
      \item \Surface supports type-based reasoning (free theorems)
    \end{itemize}
...
\begin{frame}
  ...
  \item Background
  \item \Surface: a gradual IFC calculus
  \item[{\color{Red} \ding{43}}] Technical development
    \begin{itemize}
    \item Formal definition of \Surface
    \item Coercion calculi for IFC
    \item The IFC cast calculus \CC
  ...
  \begin{figure}[tbp]
    ...
    \raggedright
        ...
        \begin{align*}
          ...
          \mathit{eval}(M, b) =&\, \mathtt{diverge} \;&\text{if~}\;(\compile{M})[x:=b] \mid \emptyset \Downarrow \blame{\bl{p}} \mid \mu \\
...
\begin{frame}
  ...
  \item \Surface: a gradual IFC calculus
  \item Technical development
  \item[{\color{Red} \ding{43}}] Meta-theoretic results
    \begin{itemize}
      \item Type safety for \Surface
      \item Gradual guarantee for \Surface
      \item Noninterference for \Surface
...
\begin{frame}
  ...
  \begin{itemize}
  \item It \hl{is possible} to satisfy noninterference and the
    gradual guarantee while supporting type-based reasoning.
  ...
  \vspace{10pt}
  \begin{center}
    Show me the code! The Agda mechanization of \Surface is at \\[2ex]
...
\begin{frame}
  \frametitle{\large Simulation Between More and Less Precise Coercions}
