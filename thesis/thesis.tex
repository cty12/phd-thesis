...
\newcommand{\SurfacePlus}{\ensuremath{\lambda_{\mathtt{IFC}}^\star{+}}\xspace}
...
\newcommand{\cclam}[2]{\ensuremath{\ccsyntax{${\lambda}$}{#1}\ccsyntax{.}\,{#2}}}
...
% simulation
\newcommand{\simrel}[4]{\ensuremath{{#1}\vdash{#2}\leq{#3}\Leftarrow{#4}}}
