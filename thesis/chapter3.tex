...
\raggedright
  ...
  \\[1ex]
  \textit{if-true-cast}~
  \inference{}{\reduce{\ccif{\left(\cccast{\ccconst{\true}}{\coerc{\id{\Bool}}{\id{\low}\seq\up}}\right)}{A}{\high}{M}{N}}{\mu}{\PC}{\ccprot{(\mathit{stamp}\;\PC\;\high)}{\high}{M}{A}}{\mu}}
  \\[1ex]
  ...
  \\[1ex]
  \textit{if-false-cast}~
  \inference{}{\reduce{\ccif{\left(\cccast{\ccconst{\false}}{\coerc{\id{\Bool}}{\id{\low}\seq\up}}\right)}{A}{\high}{M}{N}}{\mu}{\PC}{\ccprot{(\mathit{stamp}\;\PC\;\high)}{\high}{N}{A}}{\mu}}
  \\[1ex]
...
\raggedright
  ...
  \end{gather*}}
  \caption{Operational semantics of \CC (Part II).
  NSU checks are represented using label expressions (\highlightred{\text{highlighted}})}
