...
In my opinion, a ideal gradual security-typed language \Circled{1} should
enforce security by satisfying noninterference \Circled{2} should satisfy the
gradual guarantee \Circled{3} should provide type-based reasoning through
vigilance and type-guided classification \Circled{4} should not require addition
