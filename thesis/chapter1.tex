...
\Tree [
  ...
  {\color{green} \texttt{\{FirstName=}}
  [ .{ $\langle \mathit{ID} \rangle$ } {\color{green} \texttt{Mad}} ]
  {\color{green} \texttt{;LastName=}}
  [ .{ $\langle \mathit{ID} \rangle$ } {\color{green} \texttt{Hatter}} ]
  {\color{green} \texttt{;SSN=}}
                       [ .{ $\langle \mathit{SSN} \rangle$ }
                         [ .{ $\langle D \rangle$ } {\color{red} \texttt{0}} ]
                         [ .{ $\langle D \rangle$ } {\color{red} \texttt{1}} ]
                         [ .{ $\langle D \rangle$ } {\color{red} \texttt{2}} ]
                         {\color{green} \texttt{-}}
                                [ .{ $\langle D \rangle$ } {\color{red} \texttt{3}} ]
                                [ .{ $\langle D \rangle$ } {\color{red} \texttt{4}} ]
                                {\color{green} \texttt{-}}
                                       [ .{ $\langle D \rangle$ } {\color{red} \texttt{5}} ]
                                       [ .{ $\langle D \rangle$ } {\color{red} \texttt{6}} ]
                                       [ .{ $\langle D \rangle$ } {\color{red} \texttt{7}} ]
                                       [ .{ $\langle D \rangle$ } {\color{red} \texttt{8}} ] ]
                       {\color{green} \texttt{\}}}
]
\end{tikzpicture}
...
%%   section. -Jeremy}
In Section~\ref{sec:intro-static-ifc} and Section~\ref{sec:intro-dyn-ifc}, we
...
\begin{verbatim}
  x := y + z
\end{verbatim}
\noindent There are explicit flows from \key{y} to \key{x} and from \key{z} to
...
\end{verbatim}
\noindent An observer is able to learn whether \key{x} is true or false, by inspecting
...
IFC can also be enforced dynamically using runtime monitoring, an idea presented
...
labeled by default; a programmer need to use the \key{toLabeled} primitive to
...
\begin{tikzpicture}[overlay, remember picture, yshift=.25\baselineskip, shorten >=.5pt, shorten <=.5pt]
  ...
  \draw[dashed,thick] (i) to [bend right=15] (j);
