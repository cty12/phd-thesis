...
\Tree [
  ...
  {\color{blue} \textbf{\{FirstName=}}
  [ .{ $\langle ID \rangle$ } {\color{blue} \textbf{Mad}} ]
  {\color{blue} \textbf{;LastName=}}
  [ .{ $\langle ID \rangle$ } {\color{blue} \textbf{Hatter}} ]
  {\color{blue} \textbf{;SSN=}}
                       [ .{ $\langle SSN \rangle$ }
...
\caption{The parse tree generated from the example user input.
  ...
  are of high-security, while the {\color{blue} blue} ones, such as the keys
