...
We observe that \Surface programs related by precision may produce
...
list selected precision rules in Figure~\ref{fig:cc-prec}.
...
\begin{figure}[tbp]
  \raggedright
  \fbox{$\vdash M \sqsubseteq M'$}
  \begin{gather*}
    \inference{}{\vdash \const{k}{\ell} \sqsubseteq \const{k}{\ell}} \qquad
    \inference{g_1 \sqsubseteq g_2 & A_1 \sqsubseteq A_2 & \vdash N_1 \sqsubseteq N_2 }
              {\vdash \lam{g_1}{x}{A_1}{N_1}{\ell} \sqsubseteq \lam{g_2}{x}{A_2}{N_2}{\ell}} \\[1ex]
              \inference{\vdash M_1 \sqsubseteq M_2}
                        {\vdash \refexp{\ell}{M_1}{p} \sqsubseteq \refexp{\ell}{M_2}{p}} \qquad
                        \inference{\vdash M_1 \sqsubseteq M_2 & A_1 \sqsubseteq A_2}
                                  {\vdash \ann{M_1}{A_1}{p} \sqsubseteq \ann{M_2}{A_2}{p}}
  \end{gather*}
  \caption{Selected precision rules of \Surface}
