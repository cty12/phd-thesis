...
never occur in \Surface. In other words, I am going to prove that the evaluation
of a \Surface program on any input will never reach the \textit{stuck} case of
the \textit{eval} function defined in Figure~\ref{fig:eval}.
