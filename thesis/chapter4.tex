...
In this section, I first present the coerce functions that produce coercions
between security labels and types (Section~\ref{sec:coerce-func}). I then
present the compilation function from \Surface to \CC
(Section~\ref{sec:compile-func}), so that the semantics of \Surface can be given
by \CC.
} %%% end new text
