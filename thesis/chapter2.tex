...
\textcite{Amorim:2020aa}, I created a language called \SurfaceOld~\parencite{Chen:2022aa}.
Like GLIO, \SurfaceOld leaves out type-guided classification and excludes \unk from runtime
...
Like GLIO and unlike \GSLRef, \Surface satisfies the gradual guarantee.
Like \GSLRef and unlike GLIO, \Surface supports type-guided classification.
...
gets stuck. We include runtime errors as a part of \textit{diverge}: in the
context of IFC, one may not want blame to be observable in a production system
as it could reveal information. We may force the program to diverge whenever
blame is detected and send a private error message to the software developer for
debugging purposes.
