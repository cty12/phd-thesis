...
with a labeled heap. We call this language \DynIFC. We present the syntax and
semantics of \DynIFC in Figure~\ref{fig:dyn-ifc}. \DynIFC is different from a
typical dynamic IFC language in the literature (such as
...
As we are going to show in Chapter~\ref{ch:mech-metatheory}, this choice of the
dynamic extreme is intentional, so that \Surface satisfies the gradual
guarantee.
...
\begin{figure}[tbp]
  ...
  \end{gather*}}
  \caption{The syntax and the reduction semantics of \DynIFC}
  \label{fig:dyn-ifc}
\end{figure}
