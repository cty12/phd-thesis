...
the same time. I conclude this chapter by discussing the static and the dynamic
extremes of \Surface in Section~\ref{sec:embedding}. \Surface enables a
...
This section is organized as follows. I first present the syntax of \Surface and its
supporting definitions, such as security labels and security types, in
...
type $A$ become gradual (may be or contain \unk). Like \GSLRef, we replace label
...
the basics of gradual IFC using \Surface programs. In
