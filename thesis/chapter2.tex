...
{\color{NavyBlue}   %%%% new text
  ...
  \begin{figure}[tbp]
    \raggedright
        ...
        \begin{align*}
          \mathit{eval}(M, b) =&\, \mathit{obs}(V)\;&\text{if}\;(\compile(M))[x:=\ccconst{b}] \Downarrow V \\
          \mathit{eval}(M, b) =&\, \mathit{diverge} \;&\text{if~}\;(\compile(M))[x:=\ccconst{b}] \Downarrow \blame{\bl{p}} ~or~ (\compile(M))[x:=\ccconst{b}] \Uparrow \\
