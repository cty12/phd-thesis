...
\vdash M : \iota_g$, where $\iota \in \{\Unit, \Bool\}$, $g \in \{\low, \high,
\unk\}$, and $k \in \{\true, \false, \unit\}$. The \textit{eval} function
evaluates the program to a constant, signals a runtime error, or diverges:
%% \begin{align*}
